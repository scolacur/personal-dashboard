...
- [2026-07-05](2026-07-05.md) — PD-252 board hard-refresh fixed (on-demand GitHub sync, D-043; renumbered from D-041 to dodge main's D-041/D-042); PD-256 Sortie review re-work fixed — native `reactions.review_comments` was armed only at container restart (+ change-requested-only), replaced by `sortie-review-rework.yml` Actions bridge (PR #143, D-042); NAS live-diag access notes.
