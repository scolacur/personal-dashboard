...
**Kanban board** - Button to convert to github issue, and when in that view, there's a button to edit the issue template. if issues are sub-issues of a larger project/initiative (and decide on a name), that context should be shared with the sortie agent
